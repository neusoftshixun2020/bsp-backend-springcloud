package com.neusoft.basicinformation8084.mvo.entity;
...
public class Manufacturer implements BaseEntity<String> {
    @NotNull(groups={UpdateGroup.class, SelectGroup.class, DeleteGroup.class}, message = "man_id should not be null")
    int man_id;
    String name_en;
    String name_cn;
